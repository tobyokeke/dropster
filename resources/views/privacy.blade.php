...
<head>
    ...
    <title>Pivacy Policy | Dropster - A delivery service</title>
...
<section class="tm-margin-large-top">
    <div class="uk-container uk-text-center">
        ...
        <p class="uk-margin-remove-bottom tm-overtitle uk-margin-top uk-text-uppercase letter-spacing-l">PRIVACY POLICY</p>
        <h3 class="uk-article-title uk-margin-medium-bottom" style="color:#722393"> Dropster's Privacy Policy </h3>
        <p class="uk-margin-remove-bottom tm-overtitle uk-margin-top uk-text letter-spacing-l">Last Updated: {{Carbon::createFromFormat("Y-m-d H:i:s",$privacy->created_at)->toDayDateTimeString()}}</p>
        <br>
...
<section>
    <div class="uk-container">
        ...
        <p text-align="justify">DROPSTER operates http://dropsterng.com. This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the site and our application.
...
<section>
    <div class="uk-container" style="margin-bottom: 50px;">
        ...
        <ul class="uk-list uk-list-large uk-margin-medium-top">
            <li><a href="#article-1" data-uk-scroll="duration: 400; offset: 140" class="hvr-forward"><span data-uk-icon="icon: arrow-right"></span> Information Collection and Use</a></li>

        </ul>

        <article class="uk-article uk-margin-xlarge-top">
            <h2 id="article-1" class="uk-article-title uk-margin-medium-bottom">Information Collection and Use<a href="#" data-uk-totop data-uk-scroll="duration: 400" class="tm-totop uk-float-right uk-margin-small-top"></a></h2>
            <p>
                {!! $privacy->content !!}
            </p>
        </article>
